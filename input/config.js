...
const description = "Zenith Snake Collection";
// base url in case no unique metadata file i.e IPFS
const baseImageUri = "https://cxcpxi7pwgbd.usemoralis.com:2053/server";
...
const layers = [
  addLayer("Trace", { x: 0, y: 0 }, { width: width, height: height }),
  addLayer("Bg"),
  addLayer("Face"),
  addLayer("Ob"),
  addLayer("Ib"),
...
addRarityPercentForLayer("rare", "Spec", {
  super_rare: 0,
  rare: 0,
  original: 50,
});
addRarityPercentForLayer("rare", "Ears", {
  super_rare: 0,
  rare: 0,
  original: 100,
});
